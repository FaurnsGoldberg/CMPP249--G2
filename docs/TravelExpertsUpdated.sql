...
-- Dumping database structure for travelexperts
CREATE DATABASE IF NOT EXISTS `travelexperts` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci */;
USE `travelexperts`;

-- Dumping structure for table travelexperts.affiliations
...
-- Dumping data for table travelexperts.affiliations: ~7 rows (approximately)
...
-- Dumping structure for table travelexperts.agencies
...
-- Dumping data for table travelexperts.agencies: ~2 rows (approximately)
...
-- Dumping structure for table travelexperts.agents
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci ROW_FORMAT=COMPACT;

-- Dumping data for table travelexperts.agents: ~9 rows (approximately)
...
-- Dumping structure for table travelexperts.bookingdetails
...
) ENGINE=InnoDB AUTO_INCREMENT=1304 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- Dumping data for table travelexperts.bookingdetails: ~144 rows (approximately)
...
-- Dumping structure for table travelexperts.bookings
...
-- Dumping data for table travelexperts.bookings: ~135 rows (approximately)
...
-- Dumping structure for table travelexperts.classes
...
-- Dumping data for table travelexperts.classes: ~9 rows (approximately)
...
-- Dumping structure for table travelexperts.creditcards
...
-- Dumping data for table travelexperts.creditcards: ~23 rows (approximately)
...
-- Dumping structure for table travelexperts.customers
...
-- Dumping data for table travelexperts.customers: ~27 rows (approximately)
/*!40000 ALTER TABLE `customers` DISABLE KEYS */;
INSERT INTO `customers` (`CustomerId`, `CustFirstName`, `CustLastName`, `CustAddress`, `CustCity`, `CustProv`, `CustPostal`, `CustCountry`, `CustHomePhone`, `CustBusPhone`, `CustEmail`, `CustUsername`, `CustPassword`, `AgentId`) VALUES
	...
	(145, 'TestLogin', 'Test', '123 Test', 'Calgary', 'AB', 'T4C1A1', 'Canada', '5871113334', '', 'Test@Test.ca', 'TestLogin', 'TestLogin1!', NULL);
/*!40000 ALTER TABLE `customers` ENABLE KEYS */;

-- Dumping structure for table travelexperts.customers_rewards
...
-- Dumping data for table travelexperts.customers_rewards: ~20 rows (approximately)
...
-- Dumping structure for table travelexperts.fees
...
-- Dumping data for table travelexperts.fees: ~7 rows (approximately)
...
-- Dumping structure for table travelexperts.packages
...
INSERT INTO `packages` (`PackageId`, `PkgName`, `PkgDur`, `PkgStartDate`, `PkgEndDate`, `PkgDesc`, `PkgImg`, `PkgBasePrice`, `PkgAgencyCommission`) VALUES
	...
	(2, 'Polynesian Paradise', '8 days', '2024-06-01 00:00:00', '2024-06-08 00:00:00', '8 Day All Inclusive Hawaiian Vacation', 'polynesian.jpg', 3000.0000, 310.0000),
	...
	(5, 'Christmas Market Tour', '2 days', '2023-12-24 11:51:49', '2023-12-26 11:51:49', 'Guided tour of the Christmas Market.', 'christmas.jpg', 1000.0000, 150.0000),
	(6, 'The best of Italy', '5 days', '2024-06-20 11:51:49', '2024-06-25 11:51:49', 'This 5 day Italy tour delivers a dream come true e', 'italy.jpg', 3500.0000, 350.0000);
/*!40000 ALTER TABLE `packages` ENABLE KEYS */;

-- Dumping structure for table travelexperts.packages_products_suppliers
...
-- Dumping data for table travelexperts.packages_products_suppliers: ~11 rows (approximately)
...
-- Dumping structure for table travelexperts.products
...
-- Dumping data for table travelexperts.products: ~13 rows (approximately)
...
-- Dumping structure for table travelexperts.products_suppliers
...
-- Dumping data for table travelexperts.products_suppliers: ~78 rows (approximately)
...
-- Dumping structure for table travelexperts.regions
...
-- Dumping data for table travelexperts.regions: ~10 rows (approximately)
...
-- Dumping structure for table travelexperts.rewards
...
-- Dumping data for table travelexperts.rewards: ~5 rows (approximately)
...
-- Dumping structure for table travelexperts.simplebookings
CREATE TABLE IF NOT EXISTS `simplebookings` (
  `SimpleBookingId` int(11) NOT NULL AUTO_INCREMENT,
  `CustomerId` varchar(50) DEFAULT NULL,
  `PackageId` int(11) DEFAULT NULL,
  PRIMARY KEY (`SimpleBookingId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- Dumping data for table travelexperts.simplebookings: ~0 rows (approximately)
/*!40000 ALTER TABLE `simplebookings` DISABLE KEYS */;
INSERT INTO `simplebookings` (`SimpleBookingId`, `CustomerId`, `PackageId`) VALUES
	(1, 'TestLogin', 1);
/*!40000 ALTER TABLE `simplebookings` ENABLE KEYS */;

-- Dumping structure for table travelexperts.suppliercontacts
...
-- Dumping data for table travelexperts.suppliercontacts: ~341 rows (approximately)
...
-- Dumping structure for table travelexperts.suppliers
...
-- Dumping data for table travelexperts.suppliers: ~74 rows (approximately)
...
-- Dumping structure for table travelexperts.triptypes
...
-- Dumping data for table travelexperts.triptypes: ~3 rows (approximately)
